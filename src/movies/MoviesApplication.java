...
//    //give the user a list of options for viewing all the movies or by category//
//    final static String[] catagories = {"None", "All", "Drama", "Horror", "Sci-Fi", "Musical", "Comedy"};
//
//    public static void main(String[] args) {
//
//       //setup movie listener//
//       Scanner scanner = new Scanner(System.in);
//       Movie[] movieList = MoviesArray.findAll();
//
//       //loop to choose how the list of movies//
//        int choice = 1;
//        do{
//            System.out.println();
