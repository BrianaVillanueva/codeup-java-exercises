...
public class PhoneBook {
    ...
    private HashMap<String, Person> loadFile(String fileName) throws FileNotFoundException {
        ...
        while (fileScanner.hasNext()) {
            ...
            if (columns.length != 10) {
                ...
                Person person = new Person(columns[0], columns[1], columns[2], columns[3], columns[4],
